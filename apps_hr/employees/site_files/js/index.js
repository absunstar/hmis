      ...
      for (let i = 0; i < $scope.namesConversionsList.length; i++) {
        ...
        if (type == 'nameEn' && $scope.item.nameEn && $scope.item.nameEn.contains(n.nameEn)) {
          ...
          if ($scope.item.fullNameEn.split(/\s+/)[0] && $scope.item.fullNameEn.split(/\s+/)[0].contains(n.nameEn)) {
            ...
            $scope.item.fullNameAr = $scope.item.fullNameAr && $scope.item.fullNameAr.split(/\s+/)[0] ? $scope.item.fullNameAr.replace($scope.item.fullNameAr.split(/\s+/)[0], n.nameAr) : n.nameAr;
            $scope.item.nameEn = n.nameEn;
            $scope.item.nameAr = n.nameAr;
          }
          if ($scope.item.fullNameEn.split(/\s+/)[1] && $scope.item.fullNameEn.split(/\s+/)[1].contains(n.nameEn)) {
            ...
            $scope.item.fullNameAr =
              $scope.item.fullNameAr && $scope.item.fullNameAr.split(/\s+/)[1] ? $scope.item.fullNameAr.replace($scope.item.fullNameAr.split(/\s+/)[1], n.nameAr) : $scope.item.fullNameAr + ' ' + n.nameAr;
            $scope.item.parentNameEn = n.nameEn;
            $scope.item.parentNameAr = n.nameAr;
          }
          if ($scope.item.fullNameEn.split(/\s+/)[2] && $scope.item.fullNameEn.split(/\s+/)[2].contains(n.nameEn)) {
            ...
            $scope.item.fullNameAr =
              $scope.item.fullNameAr && $scope.item.fullNameAr.split(/\s+/)[2] ? $scope.item.fullNameAr.replace($scope.item.fullNameAr.split(/\s+/)[2], n.nameAr) : $scope.item.fullNameAr + ' ' + n.nameAr;
            $scope.item.grantFatherNameEn = n.nameEn;
            $scope.item.grantFatherNameAr = n.nameAr;
          }
          if ($scope.item.fullNameEn.split(/\s+/)[3] && $scope.item.fullNameEn.split(/\s+/)[3].contains(n.nameEn)) {
            ...
            $scope.item.fullNameAr =
              $scope.item.fullNameAr && $scope.item.fullNameAr.split(/\s+/)[3] ? $scope.item.fullNameAr.replace($scope.item.fullNameAr.split(/\s+/)[3], n.nameEn) : $scope.item.fullNameAr + ' ' + n.nameAr;
            $scope.item.familyNameEn = n.nameEn;
            $scope.item.familyNameAr = n.nameAr;
          }
          ...
          if ($scope.item.fullNameAr.split(/\s+/)[0] && $scope.item.fullNameAr.split(/\s+/)[0].contains(n.nameAr)) {
            ...
            $scope.item.fullNameEn = $scope.item.fullNameEn && $scope.item.fullNameEn.split(/\s+/)[0] ? $scope.item.fullNameEn.replace($scope.item.fullNameEn.split(/\s+/)[0], n.nameEn) : n.nameEn;
            $scope.item.nameEn = n.nameEn;
            $scope.item.nameAr = n.nameAr;
          }
          if ($scope.item.fullNameAr.split(/\s+/)[1] && $scope.item.fullNameAr.split(/\s+/)[1].contains(n.nameAr)) {
            ...
            $scope.item.fullNameEn =
              $scope.item.fullNameEn && $scope.item.fullNameEn.split(/\s+/)[1] ? $scope.item.fullNameEn.replace($scope.item.fullNameEn.split(/\s+/)[1], n.nameEn) : $scope.item.fullNameEn + ' ' + n.nameEn;
            $scope.item.parentNameEn = n.nameEn;
            $scope.item.parentNameAr = n.nameAr;
          }
          if ($scope.item.fullNameAr.split(/\s+/)[2] && $scope.item.fullNameAr.split(/\s+/)[2].contains(n.nameAr)) {
            ...
            $scope.item.fullNameEn =
              $scope.item.fullNameEn && $scope.item.fullNameEn.split(/\s+/)[2] ? $scope.item.fullNameEn.replace($scope.item.fullNameEn.split(/\s+/)[2], n.nameEn) : $scope.item.fullNameEn + ' ' + n.nameEn;
              $scope.item.grantFatherNameEn = n.nameEn;
            $scope.item.grantFatherNameAr = n.nameAr;
          }
          if ($scope.item.fullNameAr.split(/\s+/)[3] && $scope.item.fullNameAr.split(/\s+/)[3].contains(n.nameAr)) {
            ...
            $scope.item.fullNameEn =
              $scope.item.fullNameEn && $scope.item.fullNameEn.split(/\s+/)[3] ? $scope.item.fullNameEn.replace($scope.item.fullNameEn.split(/\s+/)[3], n.nameEn) : $scope.item.fullNameEn + ' ' + n.nameEn;
              $scope.item.familyNameEn = n.nameEn;
            $scope.item.familyNameAr = n.nameAr;
          }
        }
