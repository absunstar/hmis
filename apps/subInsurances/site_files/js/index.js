app.controller('subInsurances', function ($scope, $http, $timeout) {
  $scope.baseURL = '';
  $scope.appName = 'subInsurances';
  $scope.modalID = '#subInsurancesManageModal';
  $scope.modalSearchID = '#subInsurancesSearchModal';
  $scope.mode = 'add';
  $scope._search = {};
  $scope.structure = {
    image: '/images/subInsurances.png',
    active: true,
  };
  $scope.item = {};
  $scope.list = [];
