app.controller('employeesAdvancesPayments', function ($scope, $http, $timeout) {
    $scope.baseURL = '';
    $scope.appName = 'employeesAdvancesPayments';
    $scope.modalID = '#employeesAdvancesPaymentsManageModal';
    $scope.modalSearchID = '#employeesAdvancesPaymentsSearchModal';
    $scope.mode = 'add';
    $scope._search = {};
    $scope.structure = {
        image: { url: '/images/employeesAdvancesPayments.png' },
        requestStatus: 'new',
        active: true,
    };
    $scope.item = {};
