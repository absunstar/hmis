      ...
      doc.screensList.forEach(_sl => {
        ...
        if (_sl.id == obj.screen) {
          ...
          if (_sl.typeNumbering.id == 4) {
            ...
            if (_sl.lengthLevel) {
              obj.code = (_sl.separatorSymbol || '') + addZero(_sl.lastValue, _sl.lengthLevel)

            } else obj.code = (_sl.separatorSymbol || '') + _sl.lastValue.toString()
            ...
            _sl.yearsList.forEach(_yl => {
              if (_yl.year == new Date(obj.date).getFullYear()) {
                ...
                if (_yl.lengthLevel) {
                  obj.code = new Date(obj.date).getFullYear().toString() + (_yl.separatorSymbol || '') + addZero(_yl.lastValue, _yl.lengthLevel)

                } else {

                  obj.code = new Date(obj.date).getFullYear().toString() + (_yl.separatorSymbol || '') + _yl.lastValue.toString()
                }
              }
            });
            ...
            _sl.monthsList.forEach(_yl => {
              if (_yl.year == new Date(obj.date).getFullYear() && _yl.month == new Date(obj.date).getMonth() + 1) {
                ...
                if (_yl.lengthLevel) {
                  obj.code = new Date(obj.date).getFullYear().toString() + (new Date(obj.date).getMonth() + 1) + (_yl.separatorSymbol || '') + addZero(_yl.lastValue, _yl.lengthLevel)

                } else {

                  obj.code = new Date(obj.date).getFullYear().toString() + (new Date(obj.date).getMonth() + 1) + (_yl.separatorSymbol || '') + _yl.lastValue.toString()
                }
              }
            });
