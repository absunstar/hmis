          ...
          $http({
            ...
            data: {
              ...
              company: site.to123({
                ...
                customersCount: response.data.doc.company.customersCount,
                employeesCount: response.data.doc.company.employeesCount,
                usersCount: response.data.doc.company.usersCount,
                taxNumber: response.data.doc.company.taxNumber,
              }),
              branch: site.to123({
